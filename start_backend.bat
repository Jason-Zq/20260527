...
start "doc-review-backend" cmd /k "cd /d %ROOT%\backend && set PYTHONIOENCODING=utf-8 && set PYTHONUTF8=1 && %PY% -m uvicorn main:app --host 0.0.0.0 --port 8002 --reload"
...
echo.
echo 已分别启动后端与 worker。健康检查: http://localhost:8002/api/healthz
