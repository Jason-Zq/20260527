...
PERSON_TARGET_COLUMNS = [
    ...
    ("gender", "性别", True, True),
    ("birth_date", "出生日期(YYYY-MM-DD)", True, True),
    ...
    ("passport_issue_date", "护照签发日期(YYYY-MM-DD)", True, False),
    ("passport_expiry_date", "护照到期日期(YYYY-MM-DD)", True, False),
    ("birth_cert_no", "出生医学证编号", False, True),
    ("birth_hospital", "出生医院", False, True),
    ("school_name", "学校名", True, True),
    ("major", "专业", True, True),
    ("degree", "学位", True, True),
    ("graduation_date", "毕业日期(YYYY-MM-DD)", True, True),
