...
const routes = [
  ...
  { path: '/request-logs', component: () => import('./components/RequestLogsPage.vue'), meta: { title: '请求记录', cache: 'RequestLogsPage' } },
  { path: '/external-api-logs', component: () => import('./components/ExternalApiLogsPage.vue'), meta: { title: '外部接口记录', cache: 'ExternalApiLogsPage' } },
